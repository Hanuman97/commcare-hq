...
class ContractedPartnerForm(InternalSubscriptionManagementForm):
    ...
    software_plan_edition = forms.ChoiceField(
        choices=(
            (SoftwarePlanEdition.REPORT_BUILDER_STANDARD, SoftwarePlanEdition.REPORT_BUILDER_STANDARD),
            (SoftwarePlanEdition.REPORT_BUILDER_PRO, SoftwarePlanEdition.REPORT_BUILDER_PRO),
            (SoftwarePlanEdition.REPORT_BUILDER_ADVANCED, SoftwarePlanEdition.REPORT_BUILDER_ADVANCED),
        ),
